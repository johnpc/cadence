 ...
 * (native search). When `managed` is true the server (runtime config) has set
 * the URL — it supersedes the user's choice and the Settings fields are
 * read-only. Kept out of the component for the line/CRAP gates. */
