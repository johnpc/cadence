...
export function groupResults(items: MediaItem[]): SearchGroups {
  return {
...
function score(item: MediaItem, q: string): number {
...
export function topResult(groups: SearchGroups, query: string): MediaItem | null {
