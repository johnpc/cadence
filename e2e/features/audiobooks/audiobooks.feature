Feature: Audiobooks library
  ...
  the same real book rows, and reading progress stays live.

  Scenario: The Audiobooks tab shows real books from the library
    Given I am signed in
    When I open the Audiobooks tab
    Then I see the audiobook library with books

  Scenario: Searching the audiobook library filters the books
    Given I am signed in
    When I open the Audiobooks tab
    Then I see the audiobook library with books
